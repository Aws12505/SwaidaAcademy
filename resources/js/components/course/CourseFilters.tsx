...
export default function CourseFilters({
  ...
  const applyFilters = (next: Filters) => {
    ...
    router.get(`/${locale}/courses`, clean, { preserveState: true, preserveScroll: true });
  };
      ...
      <div className="space-y-2">
        ...
        >
          <SelectTrigger className="w-full">
            <SelectValue placeholder={locale === 'ar' ? 'جميع المنصات' : 'All Platforms'} />
          </SelectTrigger>
          <SelectContent>
            <SelectItem value={ALL}>{locale === 'ar' ? 'جميع المنصات' : 'All Platforms'}</SelectItem>
            {platforms.map((p) => (
