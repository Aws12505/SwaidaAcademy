...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Create', href: '/admin/platforms/create' },
];
        ...
        <div className="relative min-h-[100vh] flex-1 rounded-xl border border-sidebar-border/70 md:min-h-min dark:border-sidebar-border">
          <div className="p-6">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold">Create New Platform</h2>
                <p className="text-muted-foreground">Add a new platform to the system</p>
              </div>
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="rounded-lg bg-muted p-4">
                    <p className="text-sm text-muted-foreground">
                      <strong>Note:</strong> Platform names will be used to categorize courses and scholarships throughout the system.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="flex justify-end gap-4">
                ...
                <Button type="submit" disabled={processing}>{processing ? 'Creating...' : 'Create Platform'}</Button>
              </div>
            </form>
          </div>
        </div>
