          ...
          <div className="p-6">
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <p className="text-muted-foreground">Add a new blog post to the platform</p>
              </div>
            ...
            <form onSubmit={submit} className="space-y-6">
              ...
              <div className="flex justify-end gap-4">
                ...
                <Button type="submit" disabled={processing}>{processing ? 'Creating...' : 'Create Blog Post'}</Button>
              </div>
            </form>
          </div>
        </div>
