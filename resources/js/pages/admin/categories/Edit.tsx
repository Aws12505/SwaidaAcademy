...
export default function EditCategory({ category }: EditCategoryProps) {
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title={`Edit: ${category.name.en || 'Category'}`} />
          ...
          <div className="p-6">
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="rounded-lg bg-muted p-4">
                    <p className="text-sm text-muted-foreground">
                      <strong>Note:</strong> Changes to category names will be reflected across all associated courses and scholarships.
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="flex justify-end gap-4">
                ...
                <Button type="submit" disabled={processing}>{processing ? 'Updating...' : 'Update Category'}</Button>
              </div>
            </form>
          </div>
        </div>
